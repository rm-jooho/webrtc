...
1. Build and run the example server:
    ``` sh
    GO111MODULE=on go get github.com/rm-jooho/webrtc/v3
    git clone https://github.com/rm-jooho/webrtc.git $GOPATH/src/github.com/rm-jooho/webrtc
    cd $GOPATH/src/github.com/rm-jooho/webrtc/examples
    go run examples.go
    ```
